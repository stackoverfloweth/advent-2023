export type SplitByNewLine<S extends string> = S extends `${infer Line}\n${infer Rest}` ? [Line, ...SplitByNewLine<Rest>] : [S]
...
export type Example1 = SplitByNewLine<typeof example1>
